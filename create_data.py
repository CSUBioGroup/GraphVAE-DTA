...
for dataset in datasets:
    ...
    print(f"Train Fold(set) Length: {len(train_fold)}")
    print(f"Test Fold(set) Length: {len(valid_fold)}")
    print(f"Number of Unique Drugs: {len(set(drugs))}")
    print(f"Number of Unique Proteins: {len(set(prots))}")
